...
public class ProductControllerTest {
    ...
    public void listByCategoryAlimentos() throws Exception {
        ...
        .andExpect(status().isOk())
	        ...
	        .andExpect(jsonPath("$[1].name", is("Feijao")));
	}
	...
	public void listByCategoryEletrodomésticos() throws Exception {
		...
		.andExpect(jsonPath("$[0].name", is("Aspirador de po")))
	...
	public void listByCategoryMóveis() throws Exception {
		...
		.andExpect(jsonPath("$[0].name", is("Sofa")))
	...
	public void listCategoriesByLetterOccurrence() throws Exception {
		mockMvc.perform(get("/category/m/products"))
				...
				.andExpect(jsonPath("$[1].id", is(2)))
				.andExpect(jsonPath("$[1].name", is("Eletrodomesticos")));
	}
